...
while ($row = $result->fetch_assoc()) {
    echo "<option value='" . $row['showid'] . "'>" . $row['showname'] . "</option>";
}
echo "</select>";
...
if (isset($_POST['SHOWN']))
{
	...
	echo "<tr><td colspan=2 align=center><input type=\"submit\" name=\"modify\" value=\"Modify / Save\"></td></tr>";
	echo "</table>";
	echo "</form>";
