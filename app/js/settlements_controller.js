...
function findData(id){
    ...
    call.send(data, url, method, function(data) {
        if(data.tp == 1){
            ...
            $('.monies_comp').val(data['result'].se_158);
            $('.monies_pre').val(data['result'].se_159);			
            $('.money_rem_total').val(data['result'].se_160);			
            $('.overage_comp').val(data['result'].se_161);
            $('.total_comp_overage').val(data['result'].se_162);
            $('.net_star_overage').val(data['result'].se_163);
			$(".total_star_overage").val(data['result'].se_164);
			$('.overage_pre').val(data['result'].se_165);
            $('.overage_share').val(data['result'].se_166);
            $('.pre_overage_pre').val(data['result'].se_167);
...
function getUploadFile(){
    ...
    call.sendUpload(data, url, method, function(data_response) {
        if(data_response.tp == 1){
            ...
            $('.monies_comp').val(Math.round(data_response['result'].se_158 * 100) / 100);
            $('.monies_pre').val(Math.round(data_response['result'].se_159 * 100) / 100);
            $('.money_rem_total').val(Math.round(data_response['result'].se_160 * 100) / 100);			
            $('.overage_comp').val(Math.round(data_response['result'].se_161 * 100) / 100);
            $('.total_comp_overage').val(Math.round(data_response['result'].se_162 * 100) / 100);			
			$('.net_star_overage').val(Math.round(data_response['result'].se_163 * 100) / 100);
			$(".total_star_overage").val(Math.round(data_response['result'].se_164 * 100) / 100);
			$('.overage_pre').val(Math.round(data_response['result'].se_165 * 100) / 100);
            $('.overage_share').val(Math.round(data_response['result'].se_166 * 100) / 100);
            $('.pre_overage_pre').val(Math.round(data_response['result'].se_167 * 100) / 100);
