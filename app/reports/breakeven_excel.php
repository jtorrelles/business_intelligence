...
Workcell('Value','C77', '=IF(+C33-C73>0,+C33-C73,0)');
Workcell('Value','D77', '=IF(+D33-D73>0,+D33-D73,0)');
Workcell('Value','E77', '=IF(+E33-E73>0,+E33-E73,0)');
Workcell('Value','F77', '=IF(+F33-F73>0,+F33-F73,0)');
Workcell('Value','G77', '=IF(+G33-G73>0,+G33-G73,0)');
Workcell('Value','H77', '=IF(+H33-H73>0,+H33-H73,0)');
Workcell('Value','I77', '=IF(+I33-I73>0,+I33-I73,0)');
Workcell('Value','J77', '=IF(+J33-J73>0,+J33-J73,0)');
Workcell('Value','K77', '=IF(+K33-K73>0,+K33-K73,0)');
...
Workcell('Value','G80', '=IF(G77>0,IF(G77>$B$79*$B$5,$B$79*$B$5*$B$80,G77*$B$5*$B$80),0)');
Workcell('Value','H80', '=IF(H77>0,IF(H77>$B$79*$B$5,$B$79*$B$5*$B$80,H77*$B$5*$B$80),0)');
Workcell('Value','I80', '=IF(I77>0,IF(I77>$B$79*$B$5,$B$79*$B$5*$B$80,I77*$B$5*$B$80),0)');
Workcell('Value','J80', '=IF(J77>0,IF(J77>$B$79*$B$5,$B$79*$B$5*$B$80,J77*$B$5*$B$80),0)');
...
Workcell('Value','G82', '=IF(G77>0,IF(G77>$B$81*$B$5,$B$81*$B$5*$B$82,G77*$B$5*$B$82),0)');
Workcell('Value','H82', '=IF(H77>0,IF(H77>$B$81*$B$5,$B$81*$B$5*$B$82,H77*$B$5*$B$82),0)');
Workcell('Value','I82', '=IF(I77>0,IF(I77>$B$81*$B$5,$B$81*$B$5*$B$82,I77*$B$5*$B$82),0)');
Workcell('Value','J82', '=IF(J77>0,IF(J77>$B$81*$B$5,$B$81*$B$5*$B$82,J77*$B$5*$B$82),0)');
...
Workcell('Value','C91', '=SUM(C86:C90)-C87');
Workcell('Value','D91', '=SUM(D86:D90)-D87');
Workcell('Value','E91', '=SUM(E86:E90)-E87');
Workcell('Value','F91', '=SUM(F86:F90)-F87');
Workcell('Value','G91', '=SUM(G86:G90)-G87');
Workcell('Value','H91', '=SUM(H86:H90)-H87');
Workcell('Value','I91', '=SUM(I86:I90)-I87');
Workcell('Value','J91', '=SUM(J86:J90)-J87');
Workcell('Value','K91', '=SUM(K86:K90)-K87');
...
Workcell('Value','C100', '=-SUM((C96-C98)*$B$100)-C99');
Workcell('Value','D100', '=-SUM((D96-D98)*$B$100)-D99');
Workcell('Value','E100', '=-SUM((E96-E98)*$B$100)-E99');
Workcell('Value','F100', '=-SUM((F96-F98)*$B$100)-F99');
Workcell('Value','G100', '=-SUM((G96-G98)*$B$100)-G99');
Workcell('Value','H100', '=-SUM((H96-H98)*$B$100)-H99');
Workcell('Value','I100', '=-SUM((I96-I98)*$B$100)-I99');
Workcell('Value','J100', '=-SUM((J96-J98)*$B$100)-J99');
Workcell('Value','K100', '=-SUM((K96-K98)*$B$100)-K99');
