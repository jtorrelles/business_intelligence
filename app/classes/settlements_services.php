...
include '../session.php';
$description = "Accessed Settlement data for Show: ".$res["se_3"].", on Opening Date: ".$res["se_6"]." and Closing Date: ".$res["se_7"].". Current data is: 
ID: ".$res["se_1"].", 
SHOWID: ".$res["se_2"].", 
ShowNAME: ".$res["se_3"].", 
VENUEID: ".$res["se_4"].", 
VenueNAME: ".$res["se_5"].", 
OPENINGDATE: ".$res["se_6"].", 
CLOSINGDATE: ".$res["se_7"].", 
DROPCOUNT: ".$res["se_8"].", 
PAIDATTENDANCE: ".$res["se_9"].", 
COMPS: ".$res["se_10"].", 
TOTALATTENDANCE: ".$res["se_11"].", 
CAPACITY: ".$res["se_12"].", 
GROSSINTERNETSALES: ".$res["se_13"].", 
GROSSCREDITCARDSALES: ".$res["se_14"].", 
GROSSREMOTEOUTLETSALES: ".$res["se_15"].", 
GROSSSINGLETIX: ".$res["se_16"].", 
GROSSGROUPSALES1: ".$res["se_17"].", 
GROSSGROUPSALES2: ".$res["se_18"].", 
GROSSGOLDSTARPERCENTAGE: ".$res["se_19"].", 
GROSSGROUPONPERCENTAGE: ".$res["se_20"].", 
GROSSTRAVELOOPERCENTAGE: ".$res["se_21"].", 
GROSSLIVINGSOCIALPERCENTAGE: ".$res["se_22"].", 
GROSSOTHERPERCENTAGE: ". $res["se_23"].", 
GROSSOTHERAMOUNT: ". $res["se_24"].", 
TTLSUBDISCOUNT: ". $res["se_25"].", 
TTLGROUPDISCOUNT1: ".$res["se_26"].", 
TTLGROUPDISCOUNT2: ".$res["se_27"].", 
TOTALDISCOUNTS: ". $res["se_28"].", 
TTLCOMPTICKETCOST: ".$res["se_29"].", 
DEMANDPRICING: ".$res["se_30"].", 
NUMBEROFPERFORMANCES: ". $res["se_31"].", 
TOPTICKETPRICE: ". $res["se_32"].", 
USCANADIANEXCHANGERATE: ". $res["se_33"].", 
GROSSBOXOFFICEPOTENTIAL: ".$res["se_34"].", 
GROSSBOXOFFICERECEIPTS: ". $res["se_35"].", 
GROSSBOXOFFICEPERCENTAGEOFPOTENTIAL: ".$res["se_36"].", 
TAX1PERCENTAGE: ". $res["se_37"].", 
TAX1AMOUNT: ". $res["se_38"].", 
TAX2PERCENTAGE: ". $res["se_39"].", 
TAX2AMOUNT: ". $res["se_40"].", 
FACILITYPERCENTAGE: ". $res["se_41"].", 
FACILITYAMOUNT: ". $res["se_42"].", 
SUBSCRIPTIONSALESCOMMPERCENTAGE: ".$res["se_43"].", 
SUBSCRIPTIONSALESCOMMAMOUNT: ".$res["se_44"].", 
PHONESALESCOMMPERCENTAGE: ". $res["se_45"].", 
PHONESALESCOMMAMOUNT: ". $res["se_46"].", 
INTERNETSALESCOMMPERCENTAGE: ".$res["se_47"].", 
INTERNETSALESCOMMAMOUNT: ".$res["se_48"].", 
CREDITCARDSALESCOMMPERCENTAGE: ".$res["se_49"].", 
CREDITCARDSALESCOMMAMOUNT: ".$res["se_50"].", 
REMOTESALESCOMMPERCENTAGE: ".$res["se_51"].", 
REMOTESALESCOMMAMOUNT: ".$res["se_52"].", 
SINGLETIXPERCENTAGE: ".$res["se_53"].", 
SINGLETIXAMOUNT: ".$res["se_54"].", 
GROUPSALESCOMM1PERCENTAGE: ".$res["se_55"].", 
GROUPSALESCOMM1AMOUNT: ".$res["se_56"].", 
GROUPSALESCOMM2PERCENTAGE: ".$res["se_57"].", 
GROUPSALESCOMM2AMOUNT: ".$res["se_58"].", 
GOLDSTARPERCENTAGE: ". $res["se_59"].", 
GOLDSTARAMOUNT: ". $res["se_60"].", 
GROUPONPERCENTAGE: ".$res["se_61"].", 
GROUPONAMOUNT: ".$res["se_62"].", 
TRAVELZOOPERCENTAGE: ".$res["se_63"].", 
TRAVELZOOAMOUNT: ".$res["se_64"].", 
LIVINGSOCIALPERCENTAGE: ". $res["se_65"].", 
LIVINGSOCIALAMOUNT: ". $res["se_66"].", 
OTHERAPERCENTAGE: ". $res["se_67"].", 
OTHERAAMOUNT: ". $res["se_68"].", 
OTHERBPERCENTAGE: ". $res["se_69"].", 
OTHERBAMOUNT: ". $res["se_70"].", 
TOTALALLOWABLEBOEXPENSES: ". $res["se_71"].", 
DEDUCTIONSOFGBOR: ". $res["se_72"].", 
NAGBOR: ". $res["se_73"].", 
NETCOMPANYROYALTY: ".$res["se_74"].", 
TAXWITHHELDATSOURCE: ".$res["se_75"].", 
TOTALCOMPANYROYALTY: ".$res["se_76"].", 
TOTALCOMPANYGUARANTEE: ".$res["se_77"].", 
LESSOTHERDEDUCTION: ". $res["se_78"].", 
INSURANCEPERTICKET: ". $res["se_79"].", 
TICKETPRINTING1PERTICKET: ". $res["se_80"].", 
ADVERTISINGBUDGETED: ".$res["se_81"].", 
ADVERTISINGACTUAL: ".$res["se_82"].", 
STAGEHANDSLOAINBUDGETED: ".$res["se_83"].", 
STAGEHANDSLOAINACTUAL: ".$res["se_84"].", 
STAGEHANDSLOADOUTBUDGETED: ".$res["se_85"].", 
STAGEHANDSLOADOUTACTUAL: ".$res["se_86"].", 
STAGEHANDSRUNNINGBUDGETED: ".$res["se_87"].", 
STAGEHANDSRUNNINGACTUAL: ".$res["se_88"].", 
WARDROBELOADINBUDGETED: ". $res["se_89"].", 
WARDROBELOADINACTUAL: ". $res["se_90"].", 
WARDROBELOADOUTBUDGETED: ".$res["se_91"].", 
WARDROBELOADOUTACTUAL: ".$res["se_92"].", 
WARDROBERUNNINGBUDGETED: ".$res["se_93"].", 
WARDROBERUNNINGACTUAL: ".$res["se_94"].", 
LABORCATERINGBUDGETED: ".$res["se_95"].", 
LABORCATERINGACTUAL: ".$res["se_96"].", 
MUSICIANSBUDGETED: ".$res["se_97"].", 
MUSICIANSACTUAL: ".$res["se_98"].", 
INSURANCEBUDGETED: ".$res["se_99"].", 
INSURANCEACTUAL: ".$res["se_100"].", 
TICKETPRINTING1BUDGETED: ".$res["se_101"].", 
TICKETPRINTING1ACTUAL: ".$res["se_102"].", 
OTHERCBUDGETED: ". $res["se_103"].", 
OTHERCACTUAL: ". $res["se_104"].", 
SUBTOTALVARIABLEEXPENSEBUDGETED: ".$res["se_105"].", 
SUBTOTALVARIABLEEXPENSEACTUAL: ".$res["se_106"].", 
ADAEXPENSEBUDGETED: ". $res["se_107"].", 
ADAEXPENSEACTUAL: ". $res["se_108"].", 
BOXOFFICEBUDGETED: ".$res["se_109"].", 
BOXOFFICEACTUAL: ".$res["se_110"].", 
HOSPITALITYBUDGETED: ".$res["se_111"].", 
HOSPITALITYACTUAL: ".$res["se_112"].", 
THIRDPARTYBUDGETED: ". $res["se_113"].", 
THIRDPARTYACTUAL: ". $res["se_114"].", 
HOUSESTAFFBUDGETED: ". $res["se_115"].", 
HOUSESTAFFACTUAL: ". $res["se_116"].", 
LICENSESBUDGETED: ". $res["se_117"].", 
LICENSESACTUAL: ". $res["se_118"].", 
LIMOSAUTOBUDGETED: ".$res["se_119"].", 
LIMOSAUTOACTUAL: ".$res["se_120"].", 
ORCHESTRABUDGETED: ".$res["se_121"].", 
ORCHESTRAACTUAL: ".$res["se_122"].", 
PRESENTERPROFITBUDGETED: ".$res["se_123"].", 
PRESENTERPROFITACTUAL: ".$res["se_124"].", 
SECURITYBUDGETED: ". $res["se_125"].", 
SECURITYACTUAL: ". $res["se_126"].", 
PROGRAMBUDGETED: ".$res["se_127"].", 
PROGRAMACTUAL: ".$res["se_128"].", 
RENTBUDGETED: ". $res["se_129"].", 
RENTACTUAL: ". $res["se_130"].", 
SOUNDBUDGETED: ".$res["se_131"].", 
SOUNDACTUAL: ".$res["se_132"].", 
TICKETPRINTING2BUDGETED: ".$res["se_133"].", 
TICKETPRINTING2ACTUAL: ".$res["se_134"].", 
TELEPHONESBUDGETED: ". $res["se_135"].", 
TELEPHONESACTUAL: ". $res["se_136"].", 
DRYICEBUDGETED: ". $res["se_137"].", 
DRYICEACTUAL: ". $res["se_138"].", 
PRESSAGENTFEEBUDGETED: ".$res["se_139"].", 
PRESSAGENTFEEACTUAL: ".$res["se_140"].", 
OTHERDBUDGETED: ". $res["se_141"].", 
OTHERDACTUAL: ". $res["se_142"].", 
OTHEREBUDGETED: ". $res["se_143"].", 
OTHEREACTUAL: ". $res["se_144"].", 
OTHERFBUDGETED: ". $res["se_145"].", 
OTHERFACTUAL: ". $res["se_146"].", 
OTHERGBUDGETED: ". $res["se_147"].", 
OTHERGACTUAL: ". $res["se_148"].", 
PIANOBUDGETED: ".$res["se_149"].", 
PIANOACTUAL: ".$res["se_150"].", 
LOCALFIXEDBUDGETED: ". $res["se_151"].", 
LOCALFIXEDACTUAL: ". $res["se_152"].", 
SUBTOTALLOCALEXPENSESBUDGETED: ".$res["se_153"].", 
SUBTOTALLOCALEXPENSESACTUAL: ".$res["se_154"].", 
TOTALLOCALEXPENSEBUDGETED: ".$res["se_155"].", 
TOTALLOCALEXPENSEACTUAL: ".$res["se_156"].", 
TOTALENGAGEMENTEXPENSES: ".$res["se_157"].", 
MIDDLEMONIESTOCOMPANY: ".$res["se_158"].", 
MIDDLEMONIESTOPRESENTER: ".$res["se_159"].", 
MONEYREMAINING: ". $res["se_160"].", 
COMPANYOVERAGEPERCENTAGE: ". $res["se_161"].", 
TOTALCOMPANYOVERAGEAMOUNT: ".$res["se_162"].", 
NETSTARPERFORMEROVERAGEPERCENTAGE: ".$res["se_163"].", 
TOTALSTARPERFORMEROVERAGEAMOUNT: ".$res["se_164"].", 
PRESENTEROVERAGETOCOMPANY: ".$res["se_165"].", 
PRESENTEROVERAGEADJUSTED: ". $res["se_166"].", 
PRESENTEROVERAGETOPRESENTER: ".$res["se_167"].", 
TOTALCOMPANYSHARE: ".$res["se_168"].", 
LESSDIRECTCOMPANYCHARGES: ". $res["se_169"].", 
ADJUSTEDCOMPANYSHARE: ". $res["se_170"].", 
TOTALPRESENTERSHARE: ".$res["se_171"].", 
PRESENTERFACILITYFEE: ". $res["se_172"].", 
ADJUSTEDPRESENTERSHARE: ". $res["se_173"].", 
NOTES: ".$res["se_174"].", 
CITYID: ". $res["se_175"].", 
city: ". $res["se_176"].", 
state: ".$res["se_177"].", 
            ...
            if (file_exists($target_file)) {
              ...
              if ($uploadOk == 0) {
                ...
                if(move_uploaded_file($dataFileName["tmp_name"], $target_file)){
                  ...
                  $res["se_174"] = $notes;
include '../session.php';
$description = "Uploaded Settlement data for Show: ".$res["se_3"].", on Opening Date: ".$res["se_6"]." and Closing Date: ".$res["se_7"].". Current data is: 
ShowNAME: ".$res["se_3"].", 
VenueNAME: ".$res["se_5"].", 
OPENINGDATE: ".$res["se_6"].", 
CLOSINGDATE: ".$res["se_7"].", 
