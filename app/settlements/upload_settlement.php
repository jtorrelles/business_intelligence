...
echo "<form id=\"fileUploadForm\" method=\"POST\" enctype=\"multipart/form-data\">";
	echo "<table>";
	echo "<tr><td><p>Select Spreadsheet (Settlement) to upload (XLS, XLSX, ODS and CVS only):</p></td></tr>";
	echo "<tr>";
...
echo "</div>";
echo "<div style=\"display:none\" id=\"settlement_data\">";
...
echo "<table id=\"settlements_table\">
	...
	<table id=\"settlements_table\">
		...
		<tr>
			...
			<td><input type='number' class=\"exchange_rate\" value=0.0 name='exchange_rate' step=0.01></td>
		</tr>
		<tr>
			<td><b>Gross Box Office Potential:</b></td>
			<td><input type='number' name='box_office_pot' class=\"box_office_pot\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Gross Box Office Receipts:</b></td>
			<td><input type='number' name='box_office_receipts' class=\"box_office_receipts\" value=0.0 step=0.01></td>
		</tr>
		<tr>
	...
	<table id=\"settlements_table\">		
		...
		<tr>
			<td><b>Tax 1 %:</b></td>
			<td><input type='number' name='tax_1_perc' class=\"tax_1_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='tax_1_amou' class=\"tax_1_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Tax 2 and/or Percent deduction:</b></td>
			<td><input type='number' name='tax_2_perc' class=\"tax_2_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='tax_2_amou' class=\"tax_2_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Facility/Restoration Fee:</b></td>
			<td><input type='number' name='facility_perc' class=\"facility_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='facility_amou' class=\"facility_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Subscription Sales Comm:</b></td>
			<td><input type='number' name='subs_perc' class=\"subs_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='subs_amou' class=\"subs_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Phone Sales Commission:</b></td>
			<td><input type='number' name='phone_perc' class=\"phone_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='phone_amou' class=\"phone_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Internet Sales Commisssion:</b></td>
			<td><input type='number' name='internet_perc' class=\"internet_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='internet_amou' class=\"internet_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Credit Card Sales Comm:</b></td>
			<td><input type='number' name='cc_perc' class=\"cc_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='cc_amou' class=\"cc_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Remote Sales Commission:</b></td>
			<td><input type='number' name='remote_perc' class=\"remote_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='remote_amou' class=\"remote_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Single Tix (if applicable):</b></td>
			<td><input type='number' name='single_tix_perc' class=\"single_tix_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='single_tix_amou' class=\"single_tix_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Group Sales Commission 1:</b></td>
			<td><input type='number' name='group_1_perc' class=\"group_1_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='group_1_amou' class=\"group_1_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Group Sales Commission 2:</b></td>
			<td><input type='number' name='group_2_perc' class=\"group_2_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='group_2_amou' class=\"group_2_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Goldstar:</b></td>
			<td><input type='number' name='goldstar_perc' class=\"goldstar_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='goldstar_amou' class=\"goldstar_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Groupon:</b></td>
			<td><input type='number' name='groupon_perc' class=\"groupon_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='groupon_amou' class=\"groupon_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Travelzoo:</b></td>
			<td><input type='number' name='travelzoo_perc' class=\"travelzoo_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='travelzoo_amou' class=\"travelzoo_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Living Social:</b></td>
			<td><input type='number' name='living_perc' class=\"living_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='living_amou' class=\"living_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Other %:</b></td>
			<td><input type='number' name='othera_perc' class=\"othera_perc\" value=0.0 step=0.01></td>
			<td><input type='number' name='othera_amou' class=\"othera_amou\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Other $:</b></td>
	...
	<table id=\"settlements_table\">		
		...
		<tr>
			...
			<td><input type='number' name='net_com_royalty' class=\"net_com_royalty\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Tax Withheld at Source:</b></td>
			<td><input type='number' name='tax_withheld' class=\"tax_withheld\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Total Company Royalty:</b></td>
			<td><input type='number' name='total_com_royalty' class=\"total_com_royalty\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>Total Company Guarantee:</b></td>
			<td><input type='number' name='total_com_guarantee' class=\"total_com_guarantee\" value=0.0 step=0.01></td>
		</tr>
		<tr>
	...
	<table id=\"settlements_table\">		
		<tr>
			<th colspan=4>VARIABLE EXPENSE</th>
		</tr>
		<tr>
			<td></td>
			<th>Per Ticket</th>			
	...
	<table id=\"settlements_table\">
		...
		<tr>
			...
			<td><input type='number' name='ada_bug' class=\"ada_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='ada_act' class=\"ada_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>BOX OFFICE:</b></td>
			<td><input type='number' name='boxoffice_bug' class=\"boxoffice_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='boxoffice_act' class=\"boxoffice_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>HOSPITALITY (WATER):</b></td>
			<td><input type='number' name='hospitality_bug' class=\"hospitality_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='hospitality_act' class=\"hospitality_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>3RD PARTY EQUIPMENT RENTAL:</b></td>
			<td><input type='number' name='third_equip_bug' class=\"third_equip_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='third_equip_act' class=\"third_equip_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>HOUSE STAFF:</b></td>
			<td><input type='number' name='housestaff_bug' class=\"housestaff_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='housestaff_act' class=\"housestaff_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>LICENSES/PERMITS:</b></td>
			<td><input type='number' name='licenses_bug' class=\"licenses_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='licenses_act' class=\"licenses_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>LIMOS/AUTO:</b></td>
			<td><input type='number' name='limos_bug' class=\"limos_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='limos_act' class=\"limos_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>ORCHESTRA SHELL REMOVAL:</b></td>
			<td><input type='number' name='orchestra_bug' class=\"orchestra_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='orchestra_act' class=\"orchestra_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>PRESENTER PROFIT:</b></td>
			<td><input type='number' name='presenter_bug' class=\"presenter_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='presenter_act' class=\"presenter_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>POLICE/SECURITY/FIRE MARSHALL:</b></td>
			<td><input type='number' name='security_bug' class=\"security_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='security_act' class=\"security_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>PROGRAM:</b></td>
			<td><input type='number' name='program_bug' class=\"program_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='program_act' class=\"program_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>RENT:</b></td>
			<td><input type='number' name='rent_bug' class=\"rent_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='rent_act' class=\"rent_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>SOUND/LIGHTS:</b></td>
			<td><input type='number' name='soundlights_bug' class=\"soundlights_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='soundlights_act' class=\"soundlights_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>TICKET PRINTING:</b></td>
			<td><input type='number' name='ticketprinting2_bug' class=\"ticketprinting2_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='ticketprinting2_act' class=\"ticketprinting2_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>TELEPHONES/INTERNET:</b></td>
			<td><input type='number' name='phone_int_bug' class=\"phone_int_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='phone_int_act' class=\"phone_int_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>DRY ICE/CO2:</b></td>
			<td><input type='number' name='dry_bug' class=\"dry_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='dry_act' class=\"dry_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>PRESS AGENT FEE:</b></td>
			<td><input type='number' name='press_agent_bug' class=\"press_agent_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='press_agent_act' class=\"press_agent_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>OTHER:</b></td>
			<td><input type='number' name='otherd_bug' class=\"otherd_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='otherd_act' class=\"otherd_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>OTHER:</b></td>
			<td><input type='number' name='othere_bug' class=\"othere_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='othere_act' class=\"othere_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>OTHER:</b></td>
			<td><input type='number' name='otherf_bug' class=\"otherf_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='otherf_act' class=\"otherf_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>OTHER:</b></td>
			<td><input type='number' name='otherg_bug' class=\"otherg_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='otherg_act' class=\"otherg_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>PIANO TUNINGS:</b></td>
			<td><input type='number' name='piano_bug' class=\"piano_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='piano_act' class=\"piano_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>LOCAL FIXED:</b></td>
			<td><input type='number' name='local_fixed_bug' class=\"local_fixed_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='local_fixed_act' class=\"local_fixed_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>SUB-TOTAL of LOCAL EXPENSES:</b></td>
			<td><input type='number' name='st_expenses_bug' class=\"st_expenses_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='st_expenses_act' class=\"st_expenses_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>TOTAL LOCAL EXPENSE:</b></td>
			<td><input type='number' name='total_expenses_bug' class=\"total_expenses_bug\" value=0.0 step=0.01></td>
			<td><input type='number' name='total_expenses_act' class=\"total_expenses_act\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td></td>
			<th>Total</th>
	...
	<table id=\"settlements_table\">
		...
		<tr>
			...
			<td><input type='number' name='total_comp_share' class=\"total_comp_share\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>LESS DIRECT COMPANY CHARGES:</b></td>
			<td><input type='number' name='less_direct_comp' class=\"less_direct_comp\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>ADJUSTED COMPANY SHARE:</b></td>
			<td><input type='number' name='adj_comp_share' class=\"adj_comp_share\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>TOTAL PRESENTER SHARE:</b></td>
			<td><input type='number' name='total_pre_share' class=\"total_pre_share\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>PRESENTER'S FACILITY FEE:</b></td>
			<td><input type='number' name='pre_facility_fee' class=\"pre_facility_fee\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>ADJUSTED PRESENTER SHARE:</b></td>
			<td><input type='number' name='adj_pre_share' class=\"adj_pre_share\" value=0.0 step=0.01></td>
		</tr>
		<tr>
			<td><b>NOTES:</b></td>
